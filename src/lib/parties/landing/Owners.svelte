...
<div class="flex gap-32 mx-auto items-center flex-wrap">
    <img src="images/about-owners-1.jpg" class="max-w-md rounded-md mx-auto" alt="owners"/>
    <div class="flex flex-col gap-6 max-w-md mx-auto">
        <h3 class="text-2xl">Interior Design Firm Based in Kigali</h3>
        ...
        <Button suffixIcon="arrow_forward_ios" className="flex flex-row self-start gap-2" >
            Know more 
        </Button>
    </div>
